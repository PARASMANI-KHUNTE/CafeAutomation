...
const uploadToFirebase = (file, folderName = 'itemsPictures') => {
...
const deleteFromFirebase = (fileUrl, folderName = 'itemsPictures') => {
  return new Promise((resolve, reject) => {
...
const updateFromFirebase = (file, fileUrl, folderName = 'itemsPictures') => {
  return new Promise((resolve, reject) => {
    const fileName = fileUrl.split(`${folderName}/`)[1]?.split('?')[0];
    ...
    const fileToUpdate = bucket.file(`${folderName}/${fileName}`);  
...
module.exports = { uploadToFirebase, deleteFromFirebase, updateFromFirebase };